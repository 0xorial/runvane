...
const baseURL = process.env.E2E_BASE_URL ?? "http://127.0.0.1:52305";
const apiBaseURL = process.env.E2E_API_BASE_URL ?? "http://127.0.0.1:52300";
process.env.E2E_API_BASE_URL ??= apiBaseURL;

export default defineConfig({
  reporter: [
    ["list"],
    [path.join(repoRoot, "test-metrics/playwright-reporter.mjs")],
  ],
