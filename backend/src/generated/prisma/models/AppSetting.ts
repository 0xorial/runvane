...
export type AppSettingWhereInput = {
  ...
  valueJson?: Prisma.JsonFilter<"AppSetting">
...
export type AppSettingScalarWhereWithAggregatesInput = {
  ...
  valueJson?: Prisma.JsonWithAggregatesFilter<"AppSetting">
...
export type AppSettingOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "valueJson" | "updatedAt", ExtArgs["result"]["appSetting"]>
...
export interface AppSettingFieldRefs {
  ...
  readonly valueJson: Prisma.FieldRef<"AppSetting", 'Json'>
